...
FACEBOOK_APP_ID = env.str("FACEBOOK_APP_ID", None)
FACEBOOK_APP_SECRET = env.str("FACEBOOK_APP_SECRET", None)
FACEBOOK_LONG_LIVED_USER_TOKEN = env.str("FACEBOOK_LONG_LIVED_USER_TOKEN", None)
FACEBOOK_PAGE_ID = env.str("FACEBOOK_PAGE_ID", None)
FACEBOOK_PAGE_ACCESS_TOKEN = env.str("FACEBOOK_PAGE_ACCESS_TOKEN", None)
