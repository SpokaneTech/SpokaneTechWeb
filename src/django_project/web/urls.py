...
urlpatterns = [
    ...
    path("develop/", views.DevelopContentView.as_view(), name="develop"),
    ...
    re_path(r"^events/(?P<display>\w+)?$", views.TechEventsView.as_view(), name="get_events"),
    ...
    re_path(r"^techgroups/(?P<display>\w+)?$", views.TechGroupsView.as_view(), name="get_techgroups"),
]
